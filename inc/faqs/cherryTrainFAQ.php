    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>Lake Michigan air can be cool, even on what may otherwise seem to be a warm day! Dress comfortably in casual wear, but consider bringing along a jacket or light sweater, even in summer.
          Trams are covered, but the ride is open air and exposed to weather elements.  </p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab2" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>You may purchase your combination + cherry train ticket at the Northport
          Ticket Booth - the best way to reserve a seat on board the train. You may
          also purchase Tour Only tickets at Northport Ticket Booth and on a
          space-available basis at the Island Ticket Booth.</p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>No problem. Approach the ferry ticket booth in your car, and ask for a round-trip
          vehicle ticket in addition to the Combination Ferry + Cherry Train Tour ticket.
          Many people bring their car to Washington Island to spend time exploring on their
          own after the narrated tour. Cherry Train Tours do not cover the entire island or
          stop at all points of interest. You will have an opportunity to do so with your
          own transportation on your own schedule, after the introductory tour of Washington
          Island by Cherry Train.</p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p><a href="https://washingtonisland.com/" class="faqLink" target="_blank" rel="noreferrer">Washington Island</a> is a complete vacation community, a year-round community in
          ...
          you will most certainly want to bring your own vehicle.</p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>With the exception of trained service animals, we do not allow pets on the
          Cherry Train Tour. (Pets are allowed on the ferry in a vehicle, or on a leash
          on the main vehicle deck.)</p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>Since the ferry crossing takes approximately 30 minutes, board a ferry that
          leaves at least 45 minutes prior to the Cherry Train Tour start. If you look
          on our <a href="/cherry-train-tours/" class="faqLink">Cherry Train Tour Schedule</a>, you will see ferry times suggested in order
          to make a particular tour time.</p>
      </div>
    </div>
  </article>
  <article class="accordion__item js-show-item-default" data-binding="expand-accordion-item">
    ...
    <div class="accordion__content" role="tabpanel" aria-hidden="true" aria-labelledby="tab6" data-binding="expand-accordion-container">
      <div class="accordion__content-inner">
        <p>Our drivers are skilled at making these connections, and receive a high level of
          satisfaction in meeting the return ferries each time! If concerned about a tight
          connection, please ask our driver prior to boarding to reinforce the importance
          of catching the ferry. From the other side of this question, we’d like for your
          tour to be leisurely, not hurried, and you may enjoy a bit of time to shop, buy
          a snack, or just enjoy the scenery and activity prior to boarding for your
          return trip. Your round trip ferry ticket is good for any return ferry, any
          time, any day.</p>
      </div>
    </div>
  </article>
