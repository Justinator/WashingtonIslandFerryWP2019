<section id="schoolHouseSlideshow">
  ...
  <div class="pageWidth">
    ...
    <div class="slideshowWrapper">
      ...
      <div data-fadeshow="quick-nav prev-next-nav slide-counter">
        ...
        <div class="fs-slides">
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/washington-island-opening-of-the-bay.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/washington-island-beach.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/schoolHouseRocks.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
        </div>
