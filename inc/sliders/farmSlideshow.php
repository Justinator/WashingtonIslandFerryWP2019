  ...
  <div class="pageWidth">
    <div class="slideshowWrapper">
      <div data-fadeshow="quick-nav prev-next-nav slide-counter">
        ...
        <div class="fs-slides">
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/farmMuseum5.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/farmMuseum4.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/farmMuseum3.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/farmMuseum2.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
          <div class="fs-slide">
            <div class="fs-slide-bg" style="background-image: url('/wp-content/uploads/2019/04/farmMuseum1.jpg');"></div>
            <!-- Other content goes here... -->
          </div>
        </div>
        <!-- Quick Navigation -->
