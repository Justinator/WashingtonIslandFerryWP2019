...
if($this->next_previous_button)
{
    ...
    {
        $navigator_html .= '<button class="mec-previous-month mec-load-month mec-previous-month" data-mec-year="'.date('Y', $_1month_before).'" data-mec-month="'.date('m', $_1month_before).'"><i class="mec-sl-angle-left"></i> '.date_i18n('F', $_1month_before).'<span class="screen-reader-text">View the previous months schedule</span></button>';
    }
    ...
    {
        $navigator_html .= '<button class="mec-next-month mec-load-month mec-next-month" data-mec-year="'.date('Y', $_1month_after).'" data-mec-month="'.date('m', $_1month_after).'">'.date_i18n('F', $_1month_after).' <i class="mec-sl-angle-right"></i><span class="screen-reader-text">View the next months schedule</span></button>';
    }
}
